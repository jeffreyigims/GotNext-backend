...
@game6 = FactoryBot.create(:game, name: "East Liberty Game", date: Time.current, time: Time.current, description: "a basketball game around East Liberty", private: true, longitude: -79.92535151957483, latitude: 40.46512019696686)
@game7 = FactoryBot.create(:game, name: "Walnut Street Game", date: 10.days.from_now.to_date, time: Time.current, description: "a basketball game near Walnut Street", private: true, longitude: -79.92802702164988, latitude: 40.45292700833198)
...
@game11 = FactoryBot.create(:game, name: "Strip District Game", date: 7.days.from_now.to_date, time: Time.current, description: "a basketball game in the Strip District", private: true, longitude: -79.97796435290876, latitude: 40.455008279481326)
@game12 = FactoryBot.create(:game, name: "South Oakland Game", date: Time.current, time: Time.current, description: "a basketball game in South Oakland", private: false, longitude: -79.95655401764172, latitude: 40.432195976510776)
